...
public class JdbcLdapStatement implements java.sql.Statement {
    ...
    void loadSQL(String sql) throws SQLException {
        ...
        if (sqlStore == null) {
            ...
            if (con.cacheStatements()) con.cacheStatement(sql,stmt.getSqlStore());
        }
        else {
    ...
    public void addBatch(java.lang.String str) throws java.sql.SQLException {
        loadSQL(str);
        if (! stmt.isUpdate()) throw new SQLException(str + " is not an update");
        statements.add(stmt);
    }
    ...
    public boolean execute(java.lang.String str, int param) throws java.sql.SQLException {
        executeQuery(str);
        return true;
    }
    
    public boolean execute(java.lang.String str, int[] values) throws java.sql.SQLException {
        executeQuery(str);
        return true;
    }
    
    public boolean execute(java.lang.String str, java.lang.String[] str1) throws java.sql.SQLException {
        executeQuery(str);
        return true;
    }
    ...
    public java.sql.ResultSet executeQuery(java.lang.String str) throws java.sql.SQLException {
        this.loadSQL(str);
        res.unpack((NamingEnumeration) stmt.executeQuery(),stmt.getRetrieveDN(),stmt.getSqlStore().getFrom(),con.getBaseDN());
    ...
    public int executeUpdate(java.lang.String str, int param) throws java.sql.SQLException {
        return executeUpdate(str);
        
    }
    
    public int executeUpdate(java.lang.String str, int[] values) throws java.sql.SQLException {
        return executeUpdate(str);
    }
    
    public int executeUpdate(java.lang.String str, java.lang.String[] str1) throws java.sql.SQLException {
        return executeUpdate(str);
    }
